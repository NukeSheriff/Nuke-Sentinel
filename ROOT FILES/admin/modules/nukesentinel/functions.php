...
function mastermenu() {
  ...
  if(is_god($_COOKIE['admin'])) {
    echo '<td><a href="'.$admin_file.'.php?op=ABDBMaintence">'._AB_DBMAINTENCE.'</a></td></tr>'."\n";
  } else {
    echo '<td>'._AB_DBMAINTENCE.'</td></tr>'."\n";
  }
  echo '</table>'."\n";
  echo '</td>'."\n";
  echo '<td valign="top" width="50%">'."\n";
...
function databasemenu() {
  ...
  echo '<tr><td>&nbsp;</td></tr>'."\n";
  echo '<tr><td>'.help_img(_AB_HELP_113).'</td><td><a href="'.$admin_file.'.php?op=ABDBDownload">'._AB_DBDOWNLOAD.'</a></td></tr>'."\n";
  echo '</table>'."\n";
  echo '</td>'."\n";
  echo '</tr>'."\n";
  echo '</table>'."\n";
