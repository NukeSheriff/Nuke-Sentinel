...
if ($getAdmin['radminsuper'] == 1) {
  switch ($op) {
    ...
    case 'ABDBDownload':include('admin/modules/nukesentinel/ABDBDownload.php');break;
    case 'ABDBDownloadCompress':include('admin/modules/nukesentinel/ABDBDownloadCompress.php');break;
    case 'ABDBDownloadDelete':include('admin/modules/nukesentinel/ABDBDownloadDelete.php');break;
    case 'ABDBDownloadGet':include('admin/modules/nukesentinel/ABDBDownloadGet.php');break;
